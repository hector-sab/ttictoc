...
from ttictoc.tictoc import _TICTOC_HELPER_CLASS_5da0381c_27af_4d67_8881
from ttictoc.tictoc import _TICTOC_HELPER_CLASS_b178dbeb_a38c_4c13_8b0d
...
class TestNonMatlabLike:
    ...
    def test_restart_type(self):
        ...
        assert isinstance(_start_time, float), ("Invalid starting time variable type."
    ...
    def test_buffer_values(self):
        ...
        assert diff1 < 0.01 and diff2 < 0.01, ("Diff is too big. "
